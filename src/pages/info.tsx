    ...
    <>
      ...
      <div className="container">
        ...
        <section className="vinyl-card">
          ...
          <div className="genre-tags">
            <span className="genre-tag">Full-Stack Development</span>
            <span className="genre-tag">React / Next.js</span>
            <span className="genre-tag">TypeScript</span>
            <span className="genre-tag">UI/UX Design</span>
          </div>
        </section>
      ...
      <footer className="footer">
        <div className="footer-content">
          ...
          <p className="copyright">© 2025 Evan Bowness. All rights reserved.</p>
        </div>
      </footer>
    </>
  );
